...
export default function Header_two() {
  ...
  return (
    <div className="bg-transparent shadow py-3">
      ...
      <div className="bg-[#05285E] w-[100%] my-3 md:flex justify-between text-white shadow-md">
        <div
          onClick={() => openMenu()}
          className={
            menuOpen
        ...
        >
          <a href="/">
            <li className="md:text-center cursor-pointer text-sm md:border-r border-white/20 p-2 border-b border-white/10 hover:bg-blue-400 hover:text-[#05285E] transition">
              Home
            </li>
          </a>
          ...
          <li
            ...
            className="md:flex hidden items-center text-center text-sm md:border-r border-white/20 p-2 hover:bg-blue-400 hover:text-white relative transition"
          >
            <p>Profil</p>
            ...
            <div
              className={
                profilOpen
                  ? "bg-[#05285E] border border-white/10 shadow-lg absolute left-0 top-9 md:w-56 z-30 w-[100%]"
                  : "hidden"
              }
            >
              <ul>
                {[
                  ...
                  <a key={i} href="#">
                    <li className="p-2 border-b border-white/10 hover:bg-blue-400 hover:text-[#05285E] transition">
                      {item}
                    </li>
                  </a>
                ))}
          ...
          {[
            ...
            <a key={i} href="#">
              <li className="md:border-r border-white/20 p-2 text-sm hover:bg-blue-400 hover:text-[#05285E] transition border-b border-white/10">
                {item}
              </li>
            </a>
          ))}
        ...
        <div className="md:flex items-center md:w-[15%] justify-evenly px-2">
          <input
            ...
            type="text"
            placeholder="Search"
            className="bg-white/10 text-white placeholder-white/60 p-2 w-full rounded-md outline-none"
            onInput={(e) => setInput(e.target.value)}
          />
          <VscSearch className="ml-2 cursor-pointer hover:text-[#05285E] transition" />
        </div>
      </div>
    </div>
  );
